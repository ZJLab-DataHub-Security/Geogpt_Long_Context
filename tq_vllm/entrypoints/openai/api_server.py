...
async def get_gen_prompt_ids_with_history_llama3(messages, prompt, system_message, 
...
async def llm_generate(request: Request) -> Response:
    ...
    # generate prompt
    prompt_ids = await get_gen_prompt_ids_with_history_llama3(chat_history, prompt, system_message, max_window_size, max_content_round)
    ...
    sampling_params["stop"] = ["<|end_of_text|>"]
